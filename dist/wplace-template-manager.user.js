...
(function() {
  ...
  const Eye = (props) => {
    return props.closed ? /* @__PURE__ */ React.createElement(
      "svg",
      {
        ...props,
        width: "800px",
  ...
  const OverlayListEntry = ({ name, image, chunk, position, isHidden, toggleVisiblity, width, height }) => {
    ...
    ), /* @__PURE__ */ React.createElement("td", { className: "groupRow", style: { gap: "2rem" } }, /* @__PURE__ */ React.createElement("button", null, /* @__PURE__ */ React.createElement(Eye, { className: "icon", closed: isHidden, onClick: toggleVisiblity })), /* @__PURE__ */ React.createElement("button", { onClick: () => navigate("/edit/" + name) }, /* @__PURE__ */ React.createElement(Cog, { className: "icon" })), /* @__PURE__ */ React.createElement(
      "button",
      {
        onClick: () => {
          window.postMessage({
